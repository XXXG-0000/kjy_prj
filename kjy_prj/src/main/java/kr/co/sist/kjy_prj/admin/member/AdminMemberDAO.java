...
public class AdminMemberDAO {
	...
	public int selectTotalNormalCount(AdminMemberSearchVO amsVO) throws PersistenceException {
		...
		try {
			totalCount = handler.selectOne("kr.co.sist.admin.adminMember.totalNormalCnt", amsVO);
		} finally {
	...
	public int selectTotalSocialCount(AdminMemberSearchVO amsVO) throws PersistenceException {
		...
		try {
			totalCount = handler.selectOne("kr.co.sist.admin.adminMember.totalSocialCnt", amsVO);
		} finally {
			mbh.closeHandler(handler);
		}//try~fi
...
//	}//selectMemberList
	...
	public List<AdminMemberDomain> selectMemberList() throws PersistenceException {
		...
		try {
			list = handler.selectList("kr.co.sist.admin.adminMember.selectMemberList");
		} finally {
			mbh.closeHandler(handler);
		}//try~fi
	...
	public AdminMemberDomain selectMemberDetail(String member_id) throws PersistenceException {
		...
		try {
			amd = handler.selectOne("kr.co.sist.admin.adminMember.selectMemberDetail", member_id);
		} finally {
			mbh.closeHandler(handler);
		}//try~fi
	...
	public int updateMember(AdminMemberVO amVO) throws PersistenceException {
		...
		try {
			rowCnt = handler.update("kr.co.sist.admin.adminMember.updateMember", amVO);
		} finally {
			mbh.closeHandler(handler);
		}//try~fi
	...
	public int deleteMember(String member_id) throws PersistenceException {
		...
		try {
			rowCnt = handler.update("kr.co.sist.admin.adminMember.deleteMember", member_id);
		} finally {
			mbh.closeHandler(handler);
		}//try~fi
