...
<script type="text/javascript">
    $(function(){
		...
		$("#addDir").click(function(){
			...
			image_preview.setAttribute("id","dir_image_preview"+num_act);
			...
			image_input.setAttribute("class","dir_image_preview"+num_act);
		...
		$("#addActor").click(function(){
			...
			$(".cast_area").append("<div>이름 <input type='text' id='drink-name-k' name='iNameK' placeholder='출연진의 이름을 입력하세요' style='width: 300px;'/></div>")<div>")
			.append("<div>")
	...
	<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
		...
		<div class="plus-container" style="height: 1400px;">
		        ...
		        <form name="insertFrm" id="insertFrm" method="post" action="/admin/movie/insert_movie_process">    
		            ...
		            <input type="text" id="genre" placeholder="장르를 입력하세요(예: 액션, 스릴러)">
		            ...
		            <input type="text" id="country" name="country_name" placeholder="국가명을 입력하세요">
		            ...
		            <div class="dir_area">
		                ...
		                이미지 <input type="file" class="dir_image_preview" name="director_img_arr" accept="image/*" onchange="previewDirectorImage(this)" style="width: 300px;">
		            </div>
