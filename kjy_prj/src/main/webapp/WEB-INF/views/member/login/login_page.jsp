            ...
            <div class="box-login">
                ...
                <form id="form1" method="post" action="#">
                    <fieldset>
                        ...
                        <div class="login">
                            <input type="text" title="아이디" id="txtUserId" name="id" placeholder="아이디"
                                   required="required" style="width: 264px"/>
                            <input type="password" title="패스워드" id="txtPassword" name="pass" placeholder="비밀번호"
                                   required="required" style="width: 264px"/>
                        </div>
                        <div class="save-id">
                            <input type="checkbox" id="loginSet"/><label>아이디 저장</label>
                        </div>
                ...
                <div>
                    <a href="" class="btn_loginNaver"><img
