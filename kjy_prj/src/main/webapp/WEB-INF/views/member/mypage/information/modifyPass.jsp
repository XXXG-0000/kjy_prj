    ...
    <div id="mycgv-content"
        ...
        <div id="detail"
            ...
            <div style="height: 200px; width: 80%; ">
                <img src="http://localhost/images/basic.png" class="profile-image" alt=""  style="width: 135px; padding: 10px; height: 135px; float: left">
                <h2 style="font-size: 45px; float: left; margin-top: 50px">정미영님</h2> <p> </p>
                ...
                <img src="http://localhost/images/pen.png" alt="" style="width: 25px; height: 25px; margin-top: 50px; margin-left: 5px; border-bottom: 2px solid #222222">
            </div>
                    ...
                    <div  style="width: 600px; padding-left: 25%; padding-top:5%;  display: flex;" >
                        <form action="" >
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" id="currentPass" style="height: 35px">
                            </div>

                            <div class="form-group">
                                <label for="newPass">새 비밀번호</label>
                                <input type="password" id="newPass" style="height: 35px">
                            </div>
                            ...
                            <div class="form-group button-group">
                                <button type="button" class="submit-button">변경</button>
