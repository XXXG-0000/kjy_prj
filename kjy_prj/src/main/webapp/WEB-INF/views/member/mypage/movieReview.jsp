        ...
        <div style="width: 70%; height: 80%;">
            ...
            <div style="width: 80%; height: 100%;  float: right">
                <div style="width: 100%; height: 10%; border-bottom: 1px solid darkgrey">
                    <p style="font-size: 25px; color: #222222; padding: 10px 10px 10px 10px">내가 쓴 평점 <span>0건</span></p>
                </div>
                <%-- 평점 리스트--%>
                <div style="width: 100%; height:90%;">
                    <div style=" height: 250px; padding: 15px 15px 15px 15px; border-bottom: 1px solid #222222; border-radius: 10px; margin: 10px">
                        ...
                        <div style="float: left">
                            <p class="box-p">모아나 모하냐</p>
                            <p class="box-p">al****3234 | 2019.21.52</p>
                            <p class="box-p">보다가 펑펑 울었습니다.</p>
                            <p class="box-p" style="padding-top: 50px">작성하기 or 수정하기</p>
                        </div>
