...
<head>
    ...
    <script type="text/javascript">
        ...
        function move(url) {
            if (url == 'movie_list') {
                location.href = "http://kjy.sist.co.kr/myPage/movieList";
            } else if (url == 'movie_view') {
                location.href = "http://kjy.sist.co.kr/myPage/movieView";
            } else {
                location.href = "http://kjy.sist.co.kr/myPage/movieReview";
            }
